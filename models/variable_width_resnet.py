...
def resnet18vw(width, pretrained=False, progress=True, **kwargs):
    r"""ResNet-18 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _vwresnet('resnet18', BasicBlock, [2, 2, 2, 2], width, pretrained, progress,
                     **kwargs)


def resnet34vw(width, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _vwresnet('resnet34', BasicBlock, [3, 4, 6, 3], width, pretrained, progress,
                     **kwargs)


def resnet50vw(width, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _vwresnet('resnet50', Bottleneck, [3, 4, 6, 3], width, pretrained, progress,
                     **kwargs)
